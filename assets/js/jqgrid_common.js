 ...
 * @returns {*}
 */
var jqGridCommonAttrSetting = jqGridCommonAttrSetting || function (rowId, val, rawObject, cm) {
 ...
 *
 * @type {jqGridExternalSelectFormatter|*|Function}
 */
var jqGridExternalSelectFormatter = jqGridExternalSelectFormatter || function(cellValue, option, rowObject) {
 ...
 * элемент с именем key, на который и вешается этот форматер
 *
 * @type {jqGridExternalSelectMultiFormatter|*|Function}
 */
var jqGridExternalSelectMultiFormatter = jqGridExternalSelectMultiFormatter || function(cellValue, option, rowObject) {
    if (option.colModel['formatoptions'] != undefined) {
        if (option.colModel['formatoptions']['criteria'] != undefined) {
            var res = option.colModel['formatoptions']['criteria'](cellValue, rowObject);
            if (res == false) {
...
var jqGridGridColumnSelector = jqGridGridColumnSelector || function(gridObj, options) {
        var me = this;
 ...
 * @type {Function}
 */
var jqGridGridBeforeSaveCell = jqGridGridBeforeSaveCell || function (rowid, cellname, value, iRow, iCol){
...
var jqGridCheckedCkeck = jqGridCheckedCkeck || function (e) {
    if( $(e).attr('checked') ){
